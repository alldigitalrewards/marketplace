        ...
        <div class="page-content">
            <table class="table table-bordered table-compare">
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="<?=$this->baseURL('resources/app/data/p40.jpg');?>" alt="Product"></a>
                    </td>
                    <td>
                        <a href="#"><img src="<?=$this->baseURL('resources/app/data/p42.jpg');?>" alt="Product"></a>
                    </td>
                    <td>
                        <a href="#"><img src="<?=$this->baseURL('resources/app/data/p41.jpg');?>" alt="Product"></a>
                    </td>
